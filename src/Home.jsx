                ...
                {!isReady && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            animate={{ rotate: [10, 6, 12], y: [5, -4, 6], x: [5, 10, 2], opacity: 1, scale: [1, 1.05, 1] }}
                        ...
                        <motion.div
                            ...
                            animate={{ rotate: [-10, -14, -8], y: [-5, 6, -4], x: [-10, -18, -6], opacity: 1, scale: [1, 1.06, 1] }}
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: [10, -6, 8], x: [10, 0, 12], scale: [0.9, 1.0, 0.92], rotate: [-6, 3, -5] }}
                            transition={{ duration: 3.6, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut', delay: 0.15 }}
                        ...
                        >
                            <svg width="92" height="92" viewBox="0 0 100 100" fill="none">
                                <path d="M50 12C58 28 72 38 88 50C72 62 58 72 50 88C42 72 28 62 12 50C28 38 42 28 50 12Z" fill="currentColor" opacity="0.5" />
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: [0, 10, -2], x: [0, -10, -2], scale: [0.85, 0.95, 0.88], rotate: [8, 0, 10] }}
                            transition={{ duration: 4.4, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut', delay: 0.25 }}
                        ...
                        >
                            <svg width="84" height="84" viewBox="0 0 100 100" fill="none">
                                <path d="M50 18C58 32 66 40 82 50C66 60 58 68 50 82C42 68 34 60 18 50C34 40 42 32 50 18Z" fill="currentColor" opacity="0.45" />
                    ...
                    <section className="relative w-full h-[60vh] md:h-[75vh] min-h-[420px]">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/25 to-[#4a3f35]/90 flex flex-col items-center justify-end pb-12 md:pb-20 px-6 text-center">
                            ...
                            >
                                ...
                                熟練のフローリストが、あなたの特別な日を彩るお花を心を込めて<br />
                                お仕立てします。
                            </motion.p>
                            <motion.div
                            ...
                            <div className="bg-[#fdfbf6]/60 backdrop-blur-sm rounded-3xl p-6 md:p-10 border border-[#ebdcd0] soft-shadow-sm max-w-5xl mx-auto space-y-12">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
                                        {[
                                            { label: '誕生日・記念日', value: 'birthday', icon: <Gift className="w-6 h-6 mb-2 text-[#bc8a7e]" /> },
                                            { label: 'お祝い', value: 'celebration', icon: <Heart className="w-6 h-6 mb-2 text-[#bc8a7e]" /> },
                                            { label: '開店・開業祝い', value: 'celebration', icon: <Store className="w-6 h-6 mb-2 text-[#bc8a7e]" /> },
                                            { label: 'お供え・お悔やみ', value: 'condolence', icon: <Leaf className="w-6 h-6 mb-2 text-[#5c6b5d]" /> },
                                            { label: '自宅用', value: 'home', icon: <CalendarHeart className="w-6 h-6 mb-2 text-[#bc8a7e]" /> },
                                        ].map((item) => (
                                            <button
                                                key={item.label}
                                                onClick={() => navigate(`/products?purpose=${item.value}`)}
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4 overflow-x-auto hide-scroll pb-4 lg:grid lg:grid-cols-5 lg:pb-0">
                                        {[
                                            { label: 'アレンジメント', value: 'arrangement', img: '/hana1.jpg' },
                                            { label: '花束（ブーケ）', value: 'bouquet', img: '/hana2.jpg' },
                                            { label: '胡蝶蘭', value: 'orchid', img: '/hana3.jpg' },
                                            { label: '観葉植物', value: 'plant', img: 'https://images.unsplash.com/photo-1459156212016-c812468e2115?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=85' },
                                            { label: 'プリザーブド', value: 'preserved', img: '/hana4.png' },
                                        ].map((item) => (
                                            <button
                                                key={item.label}
                                                onClick={() => navigate(`/products?style=${item.value}`)}
                                            ...
                                            >
                                                <div className="w-full aspect-square overflow-hidden bg-[#f5efe9]">
                                                    <img src={item.img} alt={item.label} className="w-full h-full object-cover rounded-lg group-hover:scale-110 transition-transform duration-500" loading="lazy" decoding="async" />
                                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4 overflow-x-auto hide-scroll pb-4 lg:grid lg:grid-cols-5 lg:pb-0">
                                        {[
                                            ...
                                            { label: 'ピンク系', value: 'pink', color: 'bg-pink-400' },
                                            { label: '黄・オレンジ系', value: 'yellow_orange', color: 'bg-yellow-400' },
                                            { label: '白系', value: 'white', color: 'bg-zinc-200' },
                                            { label: 'ブルー・パープル系', value: 'blue_purple', color: 'bg-blue-600' },
                                        ].map((item) => (
                                            <button
                                                key={item.label}
                                                onClick={() => navigate(`/products?color=${item.value}`)}
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {[
                                            ...
                                            <button
                                                key={price.value}
                                                onClick={() => navigate(`/products?price=${price.value}`)}
                            ...
                            {recommendedLoading ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 flex-1">
                                    {recommendedProducts.map((product) => (
                                        <Link to={`/product/${product.id}`} key={product.id} className="bg-[#fffdf7] rounded-2xl md:rounded-3xl soft-shadow border border-[#ebdcd0] overflow-hidden flex flex-col group cursor-pointer block hover:shadow-[0_16px_40px_rgba(74,63,53,0.1)] transition-shadow duration-300">
                        ...
                        <div className="max-w-6xl mx-auto">
                            ...
                            <div className="mt-12 md:mt-14 max-w-3xl mx-auto space-y-5 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 justify-items-center">
                                <div className="w-full max-w-[320px] h-full min-h-[84px] flex items-start gap-4 bg-[#fdfbf6] px-6 py-5 rounded-2xl border border-[#ebdcd0] soft-shadow-sm transition-transform hover:-translate-y-1 min-w-0">
                                    <Award className="text-[#bc8a7e] shrink-0" size={28} strokeWidth={2} />
                                    <span className="min-w-0 flex-1 font-bold text-[#4a3f35] text-[1.02rem] tracking-wider whitespace-normal break-words leading-snug">創業100余年の信頼</span>
                                </div>
                                <div className="w-full max-w-[320px] h-full min-h-[84px] flex items-start gap-4 bg-[#fdfbf6] px-6 py-5 rounded-2xl border border-[#ebdcd0] soft-shadow-sm transition-transform hover:-translate-y-1 min-w-0">
                                    <HeartHandshake className="text-[#bc8a7e] shrink-0" size={28} strokeWidth={2} />
                                    <span className="min-w-0 flex-1 font-bold text-[#4a3f35] text-[1.02rem] tracking-wider whitespace-normal break-words leading-snug">経験豊富なフローリスト</span>
                                </div>
                                <div className="w-full max-w-[320px] h-full min-h-[84px] flex items-start gap-4 bg-[#fdfbf6] px-6 py-5 rounded-2xl border border-[#ebdcd0] soft-shadow-sm transition-transform hover:-translate-y-1 md:col-span-2 lg:col-span-1 min-w-0">
                                    <Truck className="text-[#bc8a7e] shrink-0" size={28} strokeWidth={2} />
                                    <span className="min-w-0 flex-1 font-bold text-[#4a3f35] text-[1.02rem] tracking-wider whitespace-normal break-words leading-snug">小樽市内・全国配送対応</span>
                                </div>
                            </div>
                        </div>
                    </motion.section>
